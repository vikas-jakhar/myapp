                    ...
                    <div className={`${open ? "strat-0" : "left-100"} d-flex align-items-center gap-32 menu-list`}>
                        ...
                        <div className=' d-flex cursor-pointer ml-28'>
                            ...
                            <Dropdown>
                                ...
                                <Dropdown.Menu>
                                    <Dropdown.Item href="#/action-1" className=' font-manrope fw-medium color-white-primary'>English</Dropdown.Item>
                                    <Dropdown.Item href="#/action-2" className=' font-manrope fw-medium color-white-primary'>Italian</Dropdown.Item>
                                    <Dropdown.Item href="#/action-3" className=' font-manrope fw-medium color-white-primary'>Hindi</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </div>
                    </div>
